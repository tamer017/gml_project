...
class OptInit:
    def __init__(self):
        ...
        parser.add_argument(' ', action='store_true', default=True, help='Data Augmentation')
        ...
        parser.add_argument('--epochs', type=int, default=400, metavar='N',
                            help='number of episode to trainlF ')
        ...
        # ----------------- Model related
        parser.add_argument('--k', default=15, type=int, help='neighbor num (default:9)')
        ...
        parser.add_argument('--n_blocks', type=int, default=4, help='number of basic blocks in the backbone')
    ...
    def _generate_exp_directory(self):
        ...
        if not self.args.exp_name:
            self.args.exp_name = '{}_cls-{}-{}-n{}-C{}-norm_{}-k{}-drop{}-lr{}-B{}-seed{}' \
                .format(self.args.dataset.lower(),
